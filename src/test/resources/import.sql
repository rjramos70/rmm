...
INSERT INTO op_family(name, created_by, created_on, updated_by, updated_on) VALUES ('Mac Test', 'renato', CURRENT_TIMESTAMP, 'renato', CURRENT_TIMESTAMP);
INSERT INTO op_family(name, created_by, created_on, updated_by, updated_on) VALUES ('Windows Test', 'renato', CURRENT_TIMESTAMP, 'renato', CURRENT_TIMESTAMP);
...
INSERT INTO types(description, op_id, created_by,created_on,updated_by,updated_on) VALUES ('Windows Test', 1, 'renato', CURRENT_TIMESTAMP, 'renato', CURRENT_TIMESTAMP);
...
INSERT INTO device(system_name, qtd, type_id,created_by,created_on,updated_by,updated_on) VALUES ('WINDOWS_002', 1, 1, 'renato', CURRENT_TIMESTAMP, 'renato', CURRENT_TIMESTAMP);
...
INSERT INTO customers_devices(customer_id, devices_id) VALUES (1, 2);

// CUSTOMERS_SERVICES
INSERT INTO customers_services(customer_id, services_id) VALUES (1, 1);
INSERT INTO customers_services(customer_id, services_id) VALUES (1, 2);
